					...
					for( GeneratingMainVO bot : data ) {
						...
						if( bot.getTopMenuId() != null && bot.getTopMenuId().equals( top.getMenuId() ) ) {
							...
							if( bot.getMenuType().equalsIgnoreCase( "link" ) ) {
								...
								view += "<li><a target=\"_blank\" href=\"" + bot.getMenuLink() + "\">" + bot.getMenuNm() + "</a></li>";
...
/*					log.info( "상위메뉴( Template 02 ) : " + top.getMenuNm() );
					...
					for( GeneratingMainVO bot : data ) {
						...
						if( bot.getTopMenuId() != null && bot.getTopMenuId().equals( top.getMenuId() ) ) {
							...
							if( bot.getMenuType().equalsIgnoreCase( "link" ) ) {
								// link O
								view += " <a target=\"_blank\" href=\"" + bot.getMenuLink() + "\" class=\"dropdown-item\">" + bot.getMenuNm() + "</a>";
					...
					for( GeneratingMainVO bot : data ) {
						...
						if( bot.getTopMenuId() != null && bot.getTopMenuId().equals( top.getMenuId() ) ) {
							...
							if( bot.getMenuType().equalsIgnoreCase( "link" ) ) {
								...
								view += "<a target=\"_blank\" class=\"dropdown-item\" href=\"" + bot.getMenuLink() + "\">" + bot.getMenuNm() + "</a>";
							}else {
								// link X
								//view += " <a href=\"" + rootPath + bot.getMenuLink() + "\" class=\"dropdown-item\">" + bot.getMenuNm() + "</a>";
						...
						if( menu.getTopMenuId().equals( topMenuId )) {
							...
							if( count == 1 ) {
								...
								if( menu.getMenuType().equalsIgnoreCase( "link" ) ) {
									...
									// link O
									view += " <li>\r\n" + 
											"        <a target=\"_blank\" href=\"" + menu.getMenuLink() + "\"" + "title=" + "\"" + menu.getTopMenuId() + " " + menu.getMenuLink() + "\"" + "class=\"nav-link link-dark\" onclick = \"resolver(this)\">\r\n" +
											"          <svg class=\"bi me-2\" width=\"16\" height=\"16\"><use xlink:href=\"\"/></svg>\r\n" + 
											menu.getMenuNm() + "\r\n" + 
											"        </a>\r\n" + 
											"      </li>";		
				...
				if( menu.getTopMenuId() != null ) {
					if( menu.getTopMenuId().equals( topMenuId )) {
						...
						if( menu.getMenuType().equalsIgnoreCase( "link" ) ) {
							// LINK O
							view += " <li class=\"nav-item\">\r\n" + 
									"        <a target=\"_blank\" href=\"" + menu.getMenuLink() + "\" class=\"nav-link\" aria-current=\"page\">\r\n" + 
									"          <svg class=\"bi me-2\" width=\"16\" height=\"16\"><use xlink:href=\"\"/></svg>\r\n" + 
									menu.getMenuNm() + "\r\n" + 
									"        </a>\r\n" + 
									"      </li>";
